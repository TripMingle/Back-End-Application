...
public class BoardService {
	...
	public Board createBoard(CreateBoardReqDTO createBoardReqDTO, User currentUser, String randomImageUrl) {
		...
		Board board = Board.builder()
			...
			.preferInstagramPicture(createBoardReqDTO.getPreferInstagramPicture())
			.preferFoodExploration(createBoardReqDTO.getPreferFoodExploration())
			.preferAdventure(createBoardReqDTO.getPreferAdventure())
			.currentCount(1)
	...
	public Board updateBoard(Long boardId, UpdateBoardReqDTO updateBoardReqDTO, User currentUser) {
		...
		UpdateBoardDTO updateBoardDTO = UpdateBoardDTO.builder()
			...
			.preferGender(updateBoardReqDTO.getPreferGender())
			.preferSmoking(updateBoardReqDTO.getPreferSmoking())
			.preferActivity(updateBoardReqDTO.getPreferActivity())
			.preferInstagramPicture(updateBoardReqDTO.getPreferInstagramPicture())
			.preferFoodExploration(updateBoardReqDTO.getPreferFoodExploration())
			.preferAdventure(updateBoardReqDTO.getPreferAdventure())
